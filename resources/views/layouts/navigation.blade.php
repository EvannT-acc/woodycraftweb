        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden sm:flex items-center space-x-6">
                <a href="{{ route('paniers.index') }}" 
                   class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-300 hover:text-accent transition">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.2 6.6A1 1 0 007 21h10a1 1 0 001-.8L20 13H7z" />
                    </svg>
                    Mon Panier
                </a>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 text-sm leading-4 font-medium rounded-md text-gray-400 bg-gray-800 hover:text-accent focus:outline-none transition duration-150 ease-in-out">
